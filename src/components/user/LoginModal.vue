<template>
  <CommonModal ref="commonModal">
    ...
    <v-form>
      ...
      <div v-if="isNotExistedUser" class="not-existed-user">
        <p>존재하지 않는 아이디입니다.<br />다른 아이디로 시도해 주세요.</p>
      </div>
...
export default {
    ...
    setup() {
        ...
        // 존재하지 않는 아이디 여부 체크
        let isNotExistedUser = ref(false);
